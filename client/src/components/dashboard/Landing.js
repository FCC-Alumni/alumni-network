...
export default () => (
  <div className="ui main text container" style={{ marginBottom: '25px' }}>
    ...
    <div className="ui segment" style={{ fontSize: '18px', paddingBottom: '35px' }}>
      <img className="ui small left floated image" src='/images/fcc_hands_in_logo.svg'/>
      <p>
      ...
      <img className="ui small right floated image" src='/images/fcc_portfolio_logo.svg'/>
      <p>
      ...
      <img className="ui small left floated image" src='/images/fcc_learn_logo.svg'/>
      <p>
      ...
      <img className="ui small right floated image" src='/images/fcc_high_five_logo.svg'/>
      <p>
